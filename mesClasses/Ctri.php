...
class Ctri {
    ...
    function TriTableau($stabAtrier)
    {
	   ...
	   // avec les lettres accentuées en clef et la lettre minuscule correspondante en valeur
         ...
         for ($x = 0; $x < $longueur_tableau - 1 && !$estTrie; $x++)
        {
            ...
            for ($i = 0; $i < $longueur_tableau - 1; $i++)
            {
                ...
                $longueurNom1 = strlen($stabAtrier[$i]->nom);
                ...
                if (ord($caract_minuscule) == ord($caract_minuscule2))
                    {
                        for ($z=1; $z< $longueurNom1; $z++) // z=1 car je commence la comparaison sur le deuxième le premier a déjà été testé
                        {
                            ...
                            /* les caractères du deuxième mot sont prélevé dans un try..catch car la longueur 
                            ...
                            catch (Exception $ex) 
                            {
                                 ...
                                 * pour cela je choisis un caractère dont le numéro d'ordre est avant les minuscule de l'alaphabet 
                            ...
                            {
                                // ils sont dans l'ordre je sors sans permuter
                                    if (ord($caract_minuscule) < ord($caract_minuscule2))
                                        {
                                            break ; // jesors de la comparaison des caractère à partir du deuxième pour passer sur le mot suivant
                                        }
                            }
                        }
                    } 
